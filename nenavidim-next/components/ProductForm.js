...
/* adding product, updating new product*/
...
export default function ProductForm({_id,title:existingTitle,description:existingDescription,price:existingPrice,images:existingImages,}){
    ...
    return (
        ...
        <div className="mb-2 flex flex-wrap gap-1">
            <ReactSortable className="flex flex-wrap gap-1" list={images} setList={updatedImagesOrder}>
            {!!images?.length && images.map(link => (
                <div key={key} className=" h-24">
            ...
            <label className="cursor-pointer text-gray-500 rounded-lg bg-gray-200 gap-1 w-24 h-24  flex items-center justify-center"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
